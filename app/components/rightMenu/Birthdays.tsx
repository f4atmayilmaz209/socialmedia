    ...
    <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-3'>
        ...
        <div className='flex items-center justify-between'>
            <div className='flex items-center gap-4'>
                <Image src="https://images.pexels.com/photos/25614397/pexels-photo-25614397/free-photo-of-kayalar-taslar-kristaller-etli-bitkiler.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="" width={40} height={40} className='w-10 h-10 rounded-full object-cover'/>
